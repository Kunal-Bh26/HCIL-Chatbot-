...
st.markdown("""
<div style="display: flex; justify-content: center; align-items: center; gap: 8px;"> {/* Reduced gap to 8px */}
    <span class="loading-wave" style="font-size: 2.5rem;">🤖</span> {/* Changed icon to 🤖 and reduced font-size to 2.5rem */}
